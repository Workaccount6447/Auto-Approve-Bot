...
async def help_cmd(client: Client, message: Message):
    reply = await message.reply(
        text=(
            ...
            "𝘰𝘳 𝘪𝘵𝘴 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴, 𝘱𝘭𝘦𝘢𝘴𝘦 𝘸𝘢𝘵𝘤𝘩 𝘵𝘩𝘦 "
            "𝘵𝘶𝘵𝘰𝘳𝘪𝘢𝘭 𝘷𝘪𝘥𝘦𝘰 𝘣𝘦𝘭𝘰𝘸.\n\n"
...
async def accept(client: Client, message: Message):
    ...
    if fwd_msg.forward_from_chat and fwd_msg.forward_from_chat.type not in [
...
async def approve_new(client: Client, m):
    if not NEW_REQ_MODE:
        return
    ...
    try:
        ...
        try:
            await client.send_message(
                ...
                f"{m.chat.title} 𝖧𝖺𝗌 𝖡𝖾𝖾𝗇 𝖠𝖼𝖼𝖾𝗉𝗍𝖾𝖽."
            )
        except:
            pass
    except Exception as e:
